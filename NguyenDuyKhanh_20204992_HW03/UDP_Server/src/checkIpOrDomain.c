...
/**
 * checkIpOrDomain - Distinguish whether the input is an IPv4 or IPv6 address or a domain name.
 *
 * This function receives a character string as input and determines whether it represents a valid
 * IPv4 address, a valid IPv6 address, a domain name, or none of these. It returns an integer code
 ...
 *
 * @param input The character string to be checked.
